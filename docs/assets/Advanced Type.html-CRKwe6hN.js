...
<span class="line"><span>     </span></span>
<span class="line"><span>type T2 = [arg: unknown]</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>项目实战无</p>`,65)])])}const r=n(l,[["render",p]]),c=JSON.parse('{"path":"/docs/Web/Ts%20_%20Js/Advanced%20Type.html","title":"常用的高级类型","lang":"zh-CN","frontmatter":{"title":"常用的高级类型","createTime":"2026/01/23 12:35:12"},"readingTime":{"minutes":4.15,"words":1246},"git":{},"filePathRelative":"docs/Web/Ts & Js/Advanced Type.md","headers":[]}');export{r as comp,c as data};
