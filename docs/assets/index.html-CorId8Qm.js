...
<span class="line"><span>     </span></span>
<span class="line"><span>type T2 = [arg: unknown]</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>项目实战无</p>`,65)])])}const r=n(l,[["render",p]]),c=JSON.parse('{"path":"/docs/web/6tszm0iu/","title":"常用的高级类型","lang":"zh-CN","frontmatter":{"title":"常用的高级类型","createTime":"2026/01/23 12:35:12","permalink":"/docs/web/6tszm0iu/"},"readingTime":{"minutes":4.16,"words":1248},"git":{},"filePathRelative":"docs/web/Ts & Js/Advanced Type.md","headers":[]}');export{r as comp,c as data};
